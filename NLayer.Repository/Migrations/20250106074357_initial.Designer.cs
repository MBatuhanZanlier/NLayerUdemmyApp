...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20250106074357_initial")]
            ...
            modelBuilder.Entity("NLayer.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2025, 1, 6, 10, 43, 57, 432, DateTimeKind.Local).AddTicks(8523),
                            Name = "Kalemler1",
                            Price = 100m,
                            Stock = 20,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2025, 1, 6, 10, 43, 57, 432, DateTimeKind.Local).AddTicks(8536),
                            Name = "Kitap",
                            Price = 300m,
                            Stock = 120,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2025, 1, 6, 10, 43, 57, 432, DateTimeKind.Local).AddTicks(8537),
                            Name = "Kitap2",
                            Price = 200m,
                            Stock = 50,
                            UpdateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
