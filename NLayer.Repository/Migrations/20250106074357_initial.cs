    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2025, 1, 6, 10, 43, 57, 432, DateTimeKind.Local).AddTicks(8523), "Kalemler1", 100m, 20, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 2, 2, new DateTime(2025, 1, 6, 10, 43, 57, 432, DateTimeKind.Local).AddTicks(8536), "Kitap", 300m, 120, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 3, 3, new DateTime(2025, 1, 6, 10, 43, 57, 432, DateTimeKind.Local).AddTicks(8537), "Kitap2", 200m, 50, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.InsertData(
                table: "ProductFeatures",
                columns: new[] { "Id", "Color", "Height", "ProductId", "Widht" },
                values: new object[] { 2, "Yeşil", 70, 2, 80 });
